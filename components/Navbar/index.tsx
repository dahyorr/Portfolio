...
const Navbar: React.FC<NavbarProps> = ({ forceTransparencyDisable: forceTransparencyDisableOverride }) => {
  const pathname = usePathname()
  const forceTransparencyDisable = forceTransparencyDisableOverride !== undefined ? forceTransparencyDisableOverride : pathname !== '/';
